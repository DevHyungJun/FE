...
export default function ReviewEdit({ params }: { params: ParamsId }) {
  const { id } = params;
  ...
  return (
    <div className="p-1 max-w-[800px] mx-auto">
      ...
      <div className="space-y-3">
        ...
        <Button className="w-full" color="success" onClick={handlePostReview} isLoading={isPending}>상품평 수정</Button>
      </div>
    </div>
  )
};